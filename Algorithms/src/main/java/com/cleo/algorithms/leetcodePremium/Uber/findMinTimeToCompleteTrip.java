...
/*
com.cleo.Uber has several cabs. The ith cab takes cabTripTime[i] minutes to complete any trip. Your task is to find the minimum time it will take com.cleo.Uber to get n trips completed with these cabs. You can assume that there is no waiting time in-between the trips.
...
Minimum time it will take com.cleo.Uber to get all n trips completed with the given cabs.
 */
