...
class FloodFreeCity {
    ...
    public static void main(String args[]) {
        ...
        int[] result = avoidFloodWithoutSpace(rains);
    ...
    public static int[] avoidFloodWithoutSpace(int[] rains) {
    ...
    private  static int findTheDryDayForLakeWithoutSpace (int[] outputArr, int currentDayIndex, int previousRainDayOnLake) {
